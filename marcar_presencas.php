...
/* Admin e professor podem marcar presenças */
...
if ($nivel != 1 && $nivel != 3) {
    $_SESSION['erro'] = 'Apenas administradores e professores podem marcar presenças.';
    header('Location: erro.php');
    exit;
}
...
<div class="container" style="padding:2vh; margin-top: 80px;">
    ...
    <h4 class="text-center mb-4">
        Aluno: <?php echo htmlspecialchars($nome_aluno); ?><br>
        Atividade: <?php echo htmlspecialchars($titulo_atividade); ?>
    </h4>
    ...
    <table class="table">
        ...
        <?php } else { ?>
            ...
            <?php while ($dia = mysqli_fetch_assoc($dias)) { 
                $data = $dia['dia'];
            ...
            ?>
                ...
                <tr>
                    ...
                    <td>
                        <span class="badge <?php echo $presente ? 'bg-success' : 'bg-danger'; ?>">
                            <?php echo $presente ? 'Presente' : 'Ausente'; ?>
                        </span>
                    </td>

                    <td>
                        <?php if ($presente) { ?>
                            <a href="desmarcar.php?aluno=<?php echo $id_aluno; ?>&atividade=<?php echo $id_atividade; ?>&dia=<?php echo urlencode($data); ?>" 
                               class="btn btn-sm btn-warning">
                                Desmarcar
                            </a>
                        <?php } else { ?>
                            <a href="marcar.php?aluno=<?php echo $id_aluno; ?>&atividade=<?php echo $id_atividade; ?>&dia=<?php echo urlencode($data); ?>" 
