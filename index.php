    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse justify-content-center" id="navbarColor01">
            ...
            <ul class="navbar-nav mx-auto align-items-center justify-content-center">
                ...
                <?php
                // Administrador
                if (isset($_SESSION['id_user']) && isset($_SESSION['nivel']) && $_SESSION['nivel'] == 1) {
                ...
                // Encarregado / Pai
                if (isset($_SESSION['id_user']) && isset($_SESSION['nivel']) && $_SESSION['nivel'] == 2) {
                    echo '<li class="nav-item dropdown">';
                ...
                // Professor
                if (isset($_SESSION['id_user']) && isset($_SESSION['nivel']) && $_SESSION['nivel'] == 3) {
                    echo '<li class="nav-item dropdown">';
        ...
        <div class="col-lg-8">
            ...
            <div class="card" style="background: rgba(255, 255, 255, 0.95); backdrop-filter: blur(10px);">
                <div class="card-body text-center" style="padding: 3rem;">
                    ...
                    <h1 style="color: #00d0ff; margin-bottom: 1.5rem;">
                        Bem-vindo à Algazarra
                    </h1>
